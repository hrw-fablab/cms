...
from .views import (
    ...
    ProjectChooserViewSet,
    DeviceCategoryChooserViewSet,
    ProjectCategoryChooserViewSet,
    OrganisationChooserViewSet,
)
...
def register_devicecategory_chooser_viewset():
    return DeviceCategoryChooserViewSet(
        "devicecategory_chooser", url_prefix="devicecategory-chooser"
    )


@hooks.register("register_admin_viewset")
def register_projectcategory_chooser_viewset():
    return ProjectCategoryChooserViewSet(
        "projectcategory_chooser", url_prefix="projectcategory-chooser"
    )


@hooks.register("register_admin_viewset")
def register_organisation_chooser_viewset():
    return OrganisationChooserViewSet(
        "organisation_chooser", url_prefix="organisation-chooser"
    )
