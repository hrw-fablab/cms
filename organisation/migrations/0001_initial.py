# Generated by Django 3.2.12 on 2022-04-11 16:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='test_member', to='organisation.project')),
            ],
            options={
                'verbose_name': 'Person',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='member', to='organisation.person')),
            ],
            options={
